...
Formatting: your answer is rendered by a lightweight custom markdown renderer, not a full markdown/LaTeX engine. Use only: # / ## / ### headings, **bold**, *italic*, \`inline code\`, \`\`\` fenced code blocks, > blockquotes, --- horizontal rules, "- " or "* " bullet lists, "1. " numbered lists, and simple "|"-delimited tables — all unindented (do not nest lists or indent list items under one another). Never use LaTeX or math-mode notation of any kind (no $...$, no $$...$$, no \\times, \\frac, \\%, \\$, or similar TeX escapes) — write all arithmetic in plain text with normal symbols instead, e.g. "$500,000 × 20% = $100,000".
